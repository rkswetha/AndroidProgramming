...
public class SpotifyActivity extends Activity implements
    ...
    private static final String CLIENT_ID = "e3bab2d646784dfabb80df46acacf269";

    private static final String REDIRECT_URI = "heartbeatmonitor-app://callback";
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent intent) {
        ...
        if (requestCode == REQUEST_CODE) {
            ...
            if (response.getType() == AuthenticationResponse.Type.TOKEN) {
                ...
                playerConfig.useCache(false); // TO BE REMOVED LATER
